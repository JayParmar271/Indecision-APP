...
var me = new Student('Jay Parmar', '25', 'Computer Science');
console.log(me.getDescription());

var other = new Student();
console.log(other.getDescription());

var me_traveler = new Traveler('Jay Parmar', '25', 'Ahmedabad');
console.log(me_traveler.getGreeting());

var other_traveler = new Traveler();
console.log(other_traveler.getGreeting());
